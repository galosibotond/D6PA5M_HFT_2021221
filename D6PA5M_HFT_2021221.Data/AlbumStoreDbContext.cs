...
namespace D6PA5M_HFT_2021221.Data
{
    public class AlbumStoreDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Album album1 = new Album() { Id = 4001, Title = "Moving Target", ReleaseDate = new DateTime(1995, 04, 18), Stock = 1348 };
            Album album2 = new Album() { Id = 4002, Title = "Eyewitness", ReleaseDate = new DateTime(2003, 05, 20), Stock = 150 };
            Album album3 = new Album() { Id = 4003, Title = "Paper Blood", ReleaseDate = new DateTime(2006, 09, 05), Stock = 45 };
            Album album4 = new Album() { Id = 4004, Title = "Dystopia", ReleaseDate = new DateTime(2020, 11, 21), Stock = 3 };
            Album album5 = new Album() { Id = 4005, Title = "Walk The Earth", ReleaseDate = new DateTime(2006, 03, 05), Stock = 95 };
            Album album6 = new Album() { Id = 4006, Title = "Infatuator", ReleaseDate = new DateTime(2003, 01, 14), Stock = 0 };
            Album album7 = new Album() { Id = 4007, Title = "Infected", ReleaseDate = new DateTime(2013, 08, 07), Stock = 354 };
            Album album8 = new Album() { Id = 4008, Title = "Dominion", ReleaseDate = new DateTime(2017, 05, 23), Stock = 178 };
            Album album9 = new Album() { Id = 4009, Title = "Silverthorn", ReleaseDate = new DateTime(2011, 08, 13), Stock = 16 };
            Album album10 = new Album() { Id = 4010, Title = "Haven", ReleaseDate = new DateTime(2014, 09, 03), Stock = 0 };
            Album album11 = new Album() { Id = 4011, Title = "Sonatas", Stock = 120 };
            Album album12 = new Album() { Id = 4012, Title = "Concertos", Stock = 19 };
            Album album13 = new Album() { Id = 4013, Title = "Unearthed", Stock = 0 };
            Album album14 = new Album() { Id = 4014, Title = "The Mystery of Life", Stock = 0 };
            Album album15 = new Album() { Id = 4015, Title = "American III: Solitary Man", Stock = 32 };
            Album album16 = new Album() { Id = 4016, Title = "American V: A Hundred Highways", Stock = 45 };
            Album album17 = new Album() { Id = 4017, Title = "Handwritten", ReleaseDate = new DateTime(2015, 03, 05), Stock = 803 };
            Album album18 = new Album() { Id = 4018, Title = "Illuminate", ReleaseDate = new DateTime(2016, 06, 13), Stock = 769 };
            Album album19 = new Album() { Id = 4019, Title = "Shawn Mendes", ReleaseDate = new DateTime(2018, 05, 22), Stock = 413 };
            Album album20 = new Album() { Id = 4020, Title = "Wonder", ReleaseDate = new DateTime(2020, 09, 20), Stock = 665 };
